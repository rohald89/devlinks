...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-[98%] mx-auto cursor-default select-none items-center rounded-sm py-3 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 border-b not:last-of-type:border-b-0',
      className
    )}
    {...props}
  >
